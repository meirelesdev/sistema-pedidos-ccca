import PlaceOrderInput from "../../application/DTOs/PlaceOrderInput";
...
export default class OrderCreator {
    ...
    async create (input: PlaceOrderInput) {
        ...
        for( const orderItem of input.items) {
            ...
            this.stockEntryRepository.save(new StockEntry(item.id, "out", orderItem.quantity, input.issueDate))
        }
